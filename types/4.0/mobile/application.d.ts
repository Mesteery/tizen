...
declare global {
	...
	interface ApplicationManager {
		...
		getBatteryUsageInfo(
			successCallback: BatteryUsageInfoArraySuccessCallback,
			errorCallback?: ErrorCallback | null,
			days?: number | null,
			limit?: number | null,
		): void;
		getAppsUsageInfo(
			successCallback: AppsUsageInfoArraySuccessCallback,
			errorCallback?: ErrorCallback | null,
	...
	interface BatteryUsageInfoArraySuccessCallback {
		onsuccess(batteryInfoArray: Array<ApplicationBatteryUsage>): void;
	}

	interface AppsUsageInfoArraySuccessCallback {
		onsuccess(appsInfoArray: Array<ApplicationUsage>): void;
	}
